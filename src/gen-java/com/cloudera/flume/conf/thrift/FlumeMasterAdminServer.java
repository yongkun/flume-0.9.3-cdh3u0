...
public class FlumeMasterAdminServer {
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public Map<String,FlumeNodeStatusThrift> recv_getNodeStatuses() throws org.apache.thrift.TException
    {
      ...
      receiveBase(result, "getNodeStatuses");
      if (result.isSetSuccess()) {
        return result.success;
      }
    ...
    public CommandStatusThrift recv_getCmdStatus() throws org.apache.thrift.TException
    {
      ...
      receiveBase(result, "getCmdStatus");
      if (result.isSetSuccess()) {
        return result.success;
      }
    ...
    public Map<String,List<String>> recv_getMappings() throws org.apache.thrift.TException
    {
      ...
      receiveBase(result, "getMappings");
      if (result.isSetSuccess()) {
        return result.success;
      }
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public void submit(FlumeMasterCommandThrift command, org.apache.thrift.async.AsyncMethodCallback<submit_call> resultHandler) throws org.apache.thrift.TException {
      checkReady();
      submit_call method_call = new submit_call(command, resultHandler, this, ___protocolFactory, ___transport);
    ...
    public void isSuccess(long cmdid, org.apache.thrift.async.AsyncMethodCallback<isSuccess_call> resultHandler) throws org.apache.thrift.TException {
      checkReady();
      isSuccess_call method_call = new isSuccess_call(cmdid, resultHandler, this, ___protocolFactory, ___transport);
      this.___currentMethod = method_call;
      ___manager.call(method_call);
    }
    ...
    public void isFailure(long cmdid, org.apache.thrift.async.AsyncMethodCallback<isFailure_call> resultHandler) throws org.apache.thrift.TException {
      checkReady();
      isFailure_call method_call = new isFailure_call(cmdid, resultHandler, this, ___protocolFactory, ___transport);
      this.___currentMethod = method_call;
      ___manager.call(method_call);
    }
    ...
    public void getNodeStatuses(org.apache.thrift.async.AsyncMethodCallback<getNodeStatuses_call> resultHandler) throws org.apache.thrift.TException {
      checkReady();
      getNodeStatuses_call method_call = new getNodeStatuses_call(resultHandler, this, ___protocolFactory, ___transport);
      this.___currentMethod = method_call;
      ___manager.call(method_call);
    }
    ...
    public void getConfigs(org.apache.thrift.async.AsyncMethodCallback<getConfigs_call> resultHandler) throws org.apache.thrift.TException {
      checkReady();
      getConfigs_call method_call = new getConfigs_call(resultHandler, this, ___protocolFactory, ___transport);
      this.___currentMethod = method_call;
      ___manager.call(method_call);
    }
    ...
    public void hasCmdId(long cmdid, org.apache.thrift.async.AsyncMethodCallback<hasCmdId_call> resultHandler) throws org.apache.thrift.TException {
      checkReady();
      hasCmdId_call method_call = new hasCmdId_call(cmdid, resultHandler, this, ___protocolFactory, ___transport);
      this.___currentMethod = method_call;
      ___manager.call(method_call);
    }
    ...
    public void getCmdStatus(long cmdid, org.apache.thrift.async.AsyncMethodCallback<getCmdStatus_call> resultHandler) throws org.apache.thrift.TException {
      checkReady();
      getCmdStatus_call method_call = new getCmdStatus_call(cmdid, resultHandler, this, ___protocolFactory, ___transport);
      this.___currentMethod = method_call;
      ___manager.call(method_call);
    }
    ...
    public void getMappings(String physicalNode, org.apache.thrift.async.AsyncMethodCallback<getMappings_call> resultHandler) throws org.apache.thrift.TException {
      checkReady();
      getMappings_call method_call = new getMappings_call(physicalNode, resultHandler, this, ___protocolFactory, ___transport);
      this.___currentMethod = method_call;
      ___manager.call(method_call);
    }
  ...
  public static class Processor<I extends Iface> extends org.apache.thrift.TBaseProcessor implements org.apache.thrift.TProcessor {
    ...
    private static <I extends Iface> Map<String,  org.apache.thrift.ProcessFunction<I, ? extends  org.apache.thrift.TBase>> getProcessMap(Map<String,  org.apache.thrift.ProcessFunction<I, ? extends  org.apache.thrift.TBase>> processMap) {
      ...
      processMap.put("isSuccess", new isSuccess());
      processMap.put("isFailure", new isFailure());
      processMap.put("getNodeStatuses", new getNodeStatuses());
      processMap.put("getConfigs", new getConfigs());
      processMap.put("hasCmdId", new hasCmdId());
      processMap.put("getCmdStatus", new getCmdStatus());
      processMap.put("getMappings", new getMappings());
      return processMap;
    }
    ...
    private static class submit<I extends Iface> extends org.apache.thrift.ProcessFunction<I, submit_args> {
      ...
      protected submit_result getResult(I iface, submit_args args) throws org.apache.thrift.TException {
        submit_result result = new submit_result();
        result.success = iface.submit(args.command);
        result.setSuccessIsSet(true);
        return result;
      }
    }

    private static class isSuccess<I extends Iface> extends org.apache.thrift.ProcessFunction<I, isSuccess_args> {
      public isSuccess() {
        super("isSuccess");
      }

      protected isSuccess_args getEmptyArgsInstance() {
        return new isSuccess_args();
      }
      ...
      protected isSuccess_result getResult(I iface, isSuccess_args args) throws org.apache.thrift.TException {
        isSuccess_result result = new isSuccess_result();
        result.success = iface.isSuccess(args.cmdid);
        result.setSuccessIsSet(true);
        return result;
      }
    }

    private static class isFailure<I extends Iface> extends org.apache.thrift.ProcessFunction<I, isFailure_args> {
      public isFailure() {
        super("isFailure");
      }

      protected isFailure_args getEmptyArgsInstance() {
        return new isFailure_args();
      }
      ...
      protected isFailure_result getResult(I iface, isFailure_args args) throws org.apache.thrift.TException {
        isFailure_result result = new isFailure_result();
        result.success = iface.isFailure(args.cmdid);
        result.setSuccessIsSet(true);
        return result;
      }
    }

    private static class getNodeStatuses<I extends Iface> extends org.apache.thrift.ProcessFunction<I, getNodeStatuses_args> {
      public getNodeStatuses() {
        super("getNodeStatuses");
      }

      protected getNodeStatuses_args getEmptyArgsInstance() {
        return new getNodeStatuses_args();
      }
      ...
      protected getNodeStatuses_result getResult(I iface, getNodeStatuses_args args) throws org.apache.thrift.TException {
        getNodeStatuses_result result = new getNodeStatuses_result();
        result.success = iface.getNodeStatuses();
        return result;
      }
    }

    private static class getConfigs<I extends Iface> extends org.apache.thrift.ProcessFunction<I, getConfigs_args> {
      public getConfigs() {
        super("getConfigs");
      }

      protected getConfigs_args getEmptyArgsInstance() {
        return new getConfigs_args();
      }
      ...
      protected getConfigs_result getResult(I iface, getConfigs_args args) throws org.apache.thrift.TException {
        getConfigs_result result = new getConfigs_result();
        result.success = iface.getConfigs();
        return result;
      }
    }

    private static class hasCmdId<I extends Iface> extends org.apache.thrift.ProcessFunction<I, hasCmdId_args> {
      public hasCmdId() {
        super("hasCmdId");
      }

      protected hasCmdId_args getEmptyArgsInstance() {
        return new hasCmdId_args();
      }
      ...
      protected hasCmdId_result getResult(I iface, hasCmdId_args args) throws org.apache.thrift.TException {
        hasCmdId_result result = new hasCmdId_result();
        result.success = iface.hasCmdId(args.cmdid);
        result.setSuccessIsSet(true);
        return result;
      }
    }

    private static class getCmdStatus<I extends Iface> extends org.apache.thrift.ProcessFunction<I, getCmdStatus_args> {
      public getCmdStatus() {
        super("getCmdStatus");
      }

      protected getCmdStatus_args getEmptyArgsInstance() {
        return new getCmdStatus_args();
      }
      ...
      protected getCmdStatus_result getResult(I iface, getCmdStatus_args args) throws org.apache.thrift.TException {
        getCmdStatus_result result = new getCmdStatus_result();
        result.success = iface.getCmdStatus(args.cmdid);
        return result;
      }
    }

    private static class getMappings<I extends Iface> extends org.apache.thrift.ProcessFunction<I, getMappings_args> {
      public getMappings() {
        super("getMappings");
      }

      protected getMappings_args getEmptyArgsInstance() {
        return new getMappings_args();
      }
      ...
      protected getMappings_result getResult(I iface, getMappings_args args) throws org.apache.thrift.TException {
        getMappings_result result = new getMappings_result();
        result.success = iface.getMappings(args.physicalNode);
        return result;
      }
    }
  ...
  public static class submit_args implements org.apache.thrift.TBase<submit_args, submit_args._Fields>, java.io.Serializable, Cloneable   {
    ...
    public FlumeMasterCommandThrift command; // required
...
;
  ...
  public static class getNodeStatuses_result implements org.apache.thrift.TBase<getNodeStatuses_result, getNodeStatuses_result._Fields>, java.io.Serializable, Cloneable   {
    ...
    public Map<String,FlumeNodeStatusThrift> success; // required
            ...
            if (field.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                for (int _i5 = 0; _i5 < _map4.size; ++_i5)
                {
                  ...
                  FlumeNodeStatusThrift _val7; // required
...
;
  ...
  public static class getConfigs_result implements org.apache.thrift.TBase<getConfigs_result, getConfigs_result._Fields>, java.io.Serializable, Cloneable   {
    ...
    public Map<String,com.cloudera.flume.conf.thrift.ThriftFlumeConfigData> success; // required
            ...
            if (field.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                for (int _i10 = 0; _i10 < _map9.size; ++_i10)
                {
                  ...
                  com.cloudera.flume.conf.thrift.ThriftFlumeConfigData _val12; // required
  ...
  public static class getCmdStatus_result implements org.apache.thrift.TBase<getCmdStatus_result, getCmdStatus_result._Fields>, java.io.Serializable, Cloneable   {
    ...
    public CommandStatusThrift success; // required
